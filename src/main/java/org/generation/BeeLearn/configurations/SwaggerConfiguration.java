...
public class SwaggerConfiguration {
    ...
    public OpenAPI springOpenAPI () {
        return new OpenAPI()
                .info(new Info ()
                        .title("Project BeeLearn")
                        .description("Project BeeLearn")
                        .version("v0.0.1")
                        .license(new License()
                            .name("Project BeeLearn")
                            .url("https://brazil.generation.org/"))
                        .contact(new Contact()
                                .name("Github lucasApalosqui")
                                .url("https://github.com/lucasApalosqui")
                                .email("project.beelearn@gmail.com")))
                .externalDocs(new ExternalDocumentation()
                        .description("Github Project BeeLearn")
